             ...
             Center(
               child: Consumer<ProductProvider>(
                 builder: (context, value, child) => 
                  AnimatedSmoothIndicator(activeIndex:productProvider.index, count: data['images'].length,effect: const SlideEffect(activeDotColor: Colors.deepPurple,type: SlideType.slideUnder),)),
             ),
            const Divider(
              color: Colors.black,
              thickness: 1,
                      ...
                      itemBuilder: (context, index) => Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                // customRichText(title1: 'Comment:- ', title2:data['reviews'][index]['comment'].toString()=='' || data['reviews'][index]['comment'].toString()=='null'?'NA':data['reviews'][index]['comment'].toString(),t1Weight: FontWeight.bold),
                              ],
                            ),
                          )))
            },
